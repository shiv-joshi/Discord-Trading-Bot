...
TOKEN = 'ODU3MDgzNzY4MTUwMDMyMzk1.YNKbdg.p2tqVU1jzzsf_XmvCCpsiUqxgz4'
...
class pythonBuyBot():
    def __init__(self):
        self.alpaca = tradeapi.REST('PK9QYFTE430XLK8W0Y2M','QLKsseDStRid87mCrBNhLDLBdEvJskMPwQBvQgz3', alpaca_endpoint)
